...
## 整形数据类型
代码目录如下：
~/.rustup/toolchains/VERSION/lib/rustlib/src/rust/library/core/src/num
...
本节主要说明RUST的数学库所在位置。
代码目录如下：
~/.rustup/toolchains/VERSION/lib/rustlib/src/rust/library/std/src/f32.rs
...
代码路径：
~/.rustup/toolchains/VERSION/lib/rustlib/src/rust/library/core/src/option.rs
...
代码路径：
~/.rustup/toolchains/VERSION/lib/rustlib/src/rust/library/core/src/result.rs
